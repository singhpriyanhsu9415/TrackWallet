...
const categoryController = {
  ...
  update: asyncHandler(async (req, res) => {
    ...
    category.name = normalizedName || category.name;  // if name is changing
    category.type = type || category.type;           // if type is changing
    ...
    if (oldName !== updatedCategory.name) {
      await Transaction.updateMany(
        ...
        { $set: { category: updatedCategory.name,type:updatedCategory.type } }
      );
    }
